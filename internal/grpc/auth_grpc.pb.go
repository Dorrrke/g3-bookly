...
type AuthServiceClient interface {
	Register(ctx context.Context, in *UserRegister, opts ...grpc.CallOption) (*AuthResponse, error)
...
func (c *authServiceClient) Register(ctx context.Context, in *UserRegister, opts ...grpc.CallOption) (*AuthResponse, error) {
...
type AuthServiceServer interface {
	Register(context.Context, *UserRegister) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) Register(context.Context, *UserRegister) (*AuthResponse, error) {
...
func _AuthService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Register(ctx, req.(*UserRegister))
	}
